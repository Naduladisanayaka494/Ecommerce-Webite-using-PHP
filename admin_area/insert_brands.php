...
<div class="input-group w-102 mb-2 m-auto" >
  <!-- <input type="submit" class="form-control bg-info" value="Insert Categories" name="insert_cat" placeholder="Insert Categories" aria-label="Username" aria-describedby="basic-addon1" class="bg-info"> -->
