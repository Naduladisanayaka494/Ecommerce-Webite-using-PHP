        ...
        if(!isset($_GET['edit_account'])){
            if(!isset($_GET['my_orders'])){
                if(!isset($_GET['delete_account'])){
                    ...
                    if( $row_count>0){
                        echo "<h3 class='text-center text-success mt-2 mb-5'>You have <span class='text-danger'> $row_count</span> pending orders</h3>
                          <p class='text-center'> <a href='profile.php?my_orders' class='text-dark'>Order Details</a></p>";
                    }else{
                        echo "<h3 class='text-center text-success mt-2 mb-5'>You have <span class='text-danger'> 0</span> pending orders</h3>
